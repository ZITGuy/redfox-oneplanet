...
foreach ($courses as $course) {
	...
	$html .= '
			<tr>
				...
				<td bgcolor=#cccccc width=66%>' . strtoupper($course['Subject']['name']) . '</td>';
			$course_count++;
			$tcount=1;
			...
			$html .= '<td bgcolor=#cccccc width=12%>Comments</td>
			</tr>';
...
$html .= '<br/>&nbsp;';
$html .= '<br/>&nbsp;';
//$html .= pr($registration['Evaluation'], true);
...
//$next_class = $registration['EduClass']['next_class'];
//if($acgpa + 0 < 2) {
//	$next_class = $registration['EduClass']['name']; //is_numeric($registration['EduClass']['name'])? $registration['EduClass']['name'] + 1: $registration['EduClass']['name'];
//}
