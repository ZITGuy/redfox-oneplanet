...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['EduSchedule.name', '<?php __('Name'); ?>']
,			['EduSchedule.periods', '<?php __('Periods'); ?>']
,			['EduSchedule.days', '<?php __('Days'); ?>']
,			['EduSchedule.status', '<?php __('Status'); ?>']
,			['EduSchedule.created', '<?php __('Created'); ?>']
		]
	}),
	mode: 'local',
...
var eduScheduleSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var eduScheduleSearchWindow = new Ext.Window({
	title: '<?php __('Search EduSchedule'); ?>',
	modal: true,
	items: eduScheduleSearchForm,
	resizable: false,
	width: 550,
	height: 400,
