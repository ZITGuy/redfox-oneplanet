...
var eduTeacherSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var eduTeacherSearchWindow = new Ext.Window({
	title: '<?php __('Search Teacher'); ?>',
	modal: true,
	items: eduTeacherSearchForm,
	resizable: false,
	width: 550,
	height: 400,
