<?php //pr($edu_teachers_trainings); // $edu_teacher['User']['Person']['first_name'] . ' ' . $edu_teacher['User']['Person']['middle_name'] . ' (' . ?>
{
	success:true,
...
<?php $st = false; foreach($edu_teachers_trainings as $edu_teachers_training){ if($st) echo ","; ?>			{
				...
				"edu_teacher":"<?php echo $edu_teachers_training['EduTeacher']['User']['Person']['first_name'] . ' ' . $edu_teachers_training['EduTeacher']['User']['Person']['middle_name'] . ' ' . $edu_teachers_training['EduTeacher']['User']['Person']['last_name'] . ' (' . $edu_teachers_training['EduTeacher']['EduTeacher']['identity_number'] . ')'; ?>",
