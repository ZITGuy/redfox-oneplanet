...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['GradeRule.name', '<?php __('Name'); ?>']
,			['GradeRule.type', '<?php __('Type'); ?>']
,			['GradeRule.created_date', '<?php __('Created Date'); ?>']
		]
	}),
	mode: 'local',
...
var gradeRuleSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var gradeRuleSearchWindow = new Ext.Window({
	title: '<?php __('Search GradeRule'); ?>',
	modal: true,
	items: gradeRuleSearchForm,
	resizable: false,
	width: 550,
	height: 400,
