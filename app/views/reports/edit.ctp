//<script>
		...
		var ReportEditForm = new Ext.form.FormPanel({
			...
			items: [
				...
				<?php 
					$options = array();
					$options['value'] = $report['Report']['description'];
					$this->ExtForm->input('description', $options);
				?>,
				<?php 
					$options = array();
					$options['value'] = $report['Report']['function_name'];
				...
				<?php 
					...
					if(isset($parent_id))
						...
						$options['items'] = $report_categories;
					$options['value'] = $report['Report']['report_category_id'];
					$this->ExtForm->input('report_category_id', $options);
				?>			]
		});
