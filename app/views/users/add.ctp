    ...
    items: {
        ...
        items:[{
            ...
            items: [
                ...
                ?>,
                <?php 
                    $options7 = array('fieldLabel' => 'Can Change Campus', 'value' => 1);
                    $this->ExtForm->input('change_campus', $options7);
                ?>,
                <?php 
                    $options3 = array('value' => 1);
...
?>
            ...
            items: [
                ...
                <?php 
                    ...
                    $this->ExtForm->input('birth_location', $options10);
                ?>,
                <?php 
                    $options11 = array('anchor' => '80%');
                    $this->ExtForm->input('residence_location', $options11);
                ?>,
                <?php 
                    $options12 = array();
