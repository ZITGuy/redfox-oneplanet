<?php
class AmharicComponent extends object {
	var $amharic_array = array(
		...
		"0043" => "+", "0044" => ",", "0045" => "-", "0046" => ".", "/" => "/", 
		"0048" => "0", "0049" => "1", "0050" => "2", "0051" => "3", "0052" => "4", 
		"0053" => "5", "0054" => "6", "0055" => "7", "0056" => "8", "0057" => "9", 
		"0058" => ":", "0059" => ";", "<" => "<", "0061" => "=", ">" => ">", 
		"0063" => "?", "0064" => "@", "A" => "A", "B" => "B", "C" => "C", 
		"D" => "D", "E" => "E", "F" => "F", "G" => "G", "H" => "H", 
		"I" => "I", "J" => "J", "K" => "K", "L" => "L", "M" => "M", 
		"N" => "N", "O" => "O", "P" => "P", "Q" => "Q", "R" => "R", 
		"S" => "S", "T" => "T", "U" => "U", "V" => "V", "W" => "W", 
		"X" => "X", "Y" => "Y", "Z" => "Z", "0091" => "[", "0092" => "\\", 
		"0093" => "]", "0094" => "^", "0095" => "_", "0096" => "`", "0097" => "a", 
		"b" => "b", "c" => "c", "d" => "d", "e" => "e", "f" => "f", 
		"g" => "g", "h" => "h", "i" => "i", "j" => "j", "k" => "k", 
		"l" => "l", "m" => "m", "n" => "n", "o" => "o", "p" => "p", 
		"q" => "q", "r" => "r", "s" => "s", "t" => "t", "u" => "u", 
		"v" => "v", "w" => "w", "x" => "x", "y" => "y", "z" => "z", 
		"0123" => "{", "0124" => "|", "0125" => "}", "0126" => "~", "0153" => "™", 
	...
	function encode_amharic($str) {
		...
		$arrf = array_flip($this->amharic_array);
		$pieces = explode(" ", $str);
	...
	function decode_amharic($str) {
		...
		foreach($pieces as $piece) {
			for($i = 0; $i<strlen($piece); ) {
				if(substr($piece, $i, 1) == '&'){
					$out .= $this->amharic_array[substr($piece, $i + 2, 4)];
					$i+=7;
				} else {
					$out .= $this->amharic_array[substr($piece, $i, 1)];
					$i++;
				}
			}
			$out .= ' ';
