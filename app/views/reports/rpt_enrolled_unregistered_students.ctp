					...
					<div class="row">
						<div class="col-xs-12">
							<div class="box box-default collapsed-box box-solid">
								...
								<div class="box-body">
									<form id="frmSearch" method="get" action="<?php echo $this->Html->url(array('controller' => 'reports', 'action' => 'rpt_enrolled_unregistered_students')); ?>" class="col-md-6 form-horizontal">
							...
							<div class="box">
								<div class="box-header">
									<center>
										<h2 style="margin-bottom: -10px;">Enrolled But Not-Registered Students</h2><br/>
