//<script>
	...
	store: new Ext.data.ArrayStore({
            ...
            data: [
                ['Holiday.name', '<?php __('Name'); ?>'],
		['Holiday.date', '<?php __('Date'); ?>'],
		['Holiday.is_recurrent', '<?php __('Is Recurrent'); ?>'],
		['Holiday.created', '<?php __('Created'); ?>'],
		['Holiday.modified', '<?php __('Modified'); ?>']
            ]
	}),
	mode: 'local',
