...
class EduSectionsController extends EduAppController {
    ...
    function list_data2($id = null) {
        ...
        $edu_sections = $this->EduSection->find('all', array('conditions' => $conditions));
		//pr($conditions);
	   $this->EduSection->EduRegistration->recursive = -1;
        foreach($edu_sections as &$section) {
        	  $regs = $this->EduSection->EduRegistration->find('all', array('conditions' => array(
        	  	'EduRegistration.deleted' => 0, 
        	  	'EduRegistration.edu_section_id' => $section['EduSection']['id'],
        	  	'EduRegistration.edu_academic_year_id' => 20
        	  )));
    ...
    function rpt_view_students_per_section($id, $title) {
        ...
        $conditions['EduRegistration.edu_academic_year_id'] = $active_ay['EduAcademicYear']['id'];
