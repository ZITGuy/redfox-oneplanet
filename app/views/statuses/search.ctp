...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Status.name', '<?php __('Name'); ?>']
,			['Status.tables', '<?php __('Tables'); ?>']
,			['Status.remark', '<?php __('Remark'); ?>']
		]
	}),
	mode: 'local',
...
var statusSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var statusSearchWindow = new Ext.Window({
	title: '<?php __('Search Status'); ?>',
	modal: true,
	items: statusSearchForm,
	resizable: false,
	width: 550,
	height: 400,
