...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['EduDay.date', '<?php __('Date'); ?>']
,			['EduDay.week_day', '<?php __('Week Day'); ?>']
,			['EduQuarter.name', '<?php __('EduQuarter'); ?>']
,			['EduDay.created', '<?php __('Created'); ?>']
,			['EduDay.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var eduDaySearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var eduDaySearchWindow = new Ext.Window({
	title: '<?php __('Search EduDay'); ?>',
	modal: true,
	items: eduDaySearchForm,
	resizable: false,
	width: 550,
	height: 400,
