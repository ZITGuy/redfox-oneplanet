...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Country.name', '<?php __('Name'); ?>']
,			['Country.code', '<?php __('Code'); ?>']
,			['Country.currency', '<?php __('Currency'); ?>']
,			['Country.nationality', '<?php __('Nationality'); ?>']
,			['Country.language', '<?php __('Language'); ?>']
		]
	}),
	mode: 'local',
...
var countrySearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var countrySearchWindow = new Ext.Window({
	title: '<?php __('Search Country'); ?>',
	modal: true,
	items: countrySearchForm,
	resizable: false,
	width: 550,
	height: 400,
