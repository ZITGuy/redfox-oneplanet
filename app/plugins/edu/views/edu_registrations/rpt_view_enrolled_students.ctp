...
<table border="0" width="100%">
	...
	<tr>
		<td align="right">
			<h2>Total Enrolled Students: ' . (count($edu_students)) . '</h2>
			<h2>Campus: Main</h2>
		</td>
	</tr>
	<tr>
...
foreach($edu_students as $student) {
    $html .= '
		<tr>
			<th>' . $student['EduStudent']['identity_number'] . '</th>
			<td>' . $student['EduStudent']['name'] . '</td>
			<td>' . $student['EduRegistration'][0]['EduClass']['name'] . '</td>
			<td>' . $student['EduStudent']['registration_date'] . '</td>
			<td>' . $student['Maker']['username'] . '</td>
        </tr>';
}
