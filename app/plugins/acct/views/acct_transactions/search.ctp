...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['AcctTransaction.name', '<?php __('Name'); ?>']
,			['AcctTransaction.description', '<?php __('Description'); ?>']
,			['AcctTransaction.cheque_number', '<?php __('Cheque Number'); ?>']
,			['AcctTransaction.invoice_number', '<?php __('Invoice Number'); ?>']
,			['AcctTransaction.transaction_date', '<?php __('Transaction Date'); ?>']
,			['AcctFiscalYear.name', '<?php __('AcctFiscalYear'); ?>']
,			['User.name', '<?php __('User'); ?>']
,			['AcctTransaction.created', '<?php __('Created'); ?>']
,			['AcctTransaction.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var acctTransactionSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					acctTransactionSearchWindow.close();
...
var acctTransactionSearchWindow = new Ext.Window({
	title: '<?php __('Search AcctTransaction'); ?>',
	modal: true,
	items: acctTransactionSearchForm,
	resizable: false,
	width: 550,
	height: 400,
