        ...
        items:[{
            ...
            items: [
                ...
                <?php 
                    ...
                    $options12['value'] = $user['Person']['birth_location'];
                    $options12['disabled'] = 'true';
                    $this->ExtForm->input('birth_location', $options12);
                ?>,
                <?php 
                    $options13 = array('anchor' => '80%');
                    $options13['value'] = $user['Person']['residence_location'];
                    $this->ExtForm->input('residence_location', $options13);
                ?>,
                <?php 
                    $options14 = array();
