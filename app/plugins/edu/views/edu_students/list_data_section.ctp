{
    ...
    rows: [
<?php $st = false; foreach($edu_registrations as $reg){  if ($reg['EduStudent']['name'] == "") continue;   if ($st) { echo ",";} ?>  {
...
?>
        ...
        "section": "<?php echo $reg['EduRegistration']['edu_section_id'] == 0? 'Not Set': $reg['EduSection']['name'] . ' - ' . $reg['EduClass']['name']; ?>"			}
<?php $st = true; } ?>		]
}
