...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['EduReceipt.invoice_number', '<?php __('Invoice Number'); ?>']
,			['EduReceipt.invoice_date', '<?php __('Invoice Date'); ?>']
,			['EduReceipt.crm_number', '<?php __('Crm Number'); ?>']
,			['EduReceipt.parent_name', '<?php __('Parent Name'); ?>']
,			['EduReceipt.parent_address', '<?php __('Parent Address'); ?>']
,			['EduStudent.name', '<?php __('EduStudent'); ?>']
,			['EduReceipt.student_name', '<?php __('Student Name'); ?>']
,			['EduReceipt.student_number', '<?php __('Student Number'); ?>']
,			['EduReceipt.student_class', '<?php __('Student Class'); ?>']
,			['EduReceipt.student_section', '<?php __('Student Section'); ?>']
,			['EduReceipt.student_academic_year', '<?php __('Student Academic Year'); ?>']
,			['EduReceipt.total_before_tax', '<?php __('Total Before Tax'); ?>']
,			['EduReceipt.total_after_tax', '<?php __('Total After Tax'); ?>']
,			['EduReceipt.VAT', '<?php __('VAT'); ?>']
,			['EduReceipt.TOT', '<?php __('TOT'); ?>']
,			['EduReceipt.created', '<?php __('Created'); ?>']
,			['EduReceipt.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var eduReceiptSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var eduReceiptSearchWindow = new Ext.Window({
	title: '<?php __('Search EduReceipt'); ?>',
	modal: true,
	items: eduReceiptSearchForm,
	resizable: false,
	width: 550,
	height: 400,
