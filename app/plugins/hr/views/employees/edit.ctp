            ...
            App::import('Amharic');
                ...
                $employee['User']['Person']['last_name_am']=Amharic::decode_amharic($employee['User']['Person']['last_name_am']);
                            ...
                            { 
                                xtype: 'compositefield',
                                labelWidth: 120,
                                fieldLabel: '<span style="color:red;">*</span>Mother Name:',
                                defaults: {
                                    flex: 1
                                },
                                items:[
                                    ...
                                    <?php
                                        $options2 = array(
                                            'enableKeyEvents' => 'true',
                                            'anchor' => '99%', 'emptyText' => 'የእናት ስም');
                                        $options2['listeners'] = '{
                                            keypress: function(tb,e){
                                                translateOnKeyPress(e,1);
                                            }
                                        }';
                                        $options2['value'] = $employee['Employee']['mother_name_am'];
                                        $this->ExtForm->input('mother_name_am', $options2);
                                    ?>
                                ]
                            },
                            <?php
                            ...
                            ?>,
                                        ...
                                        $options2['value'] = $employee['Employee']['biher'];
                                        $this->ExtForm->input('biher', $options2);
                                    ?>,
                            <?php
                                $this->ExtForm->create('Person');
                                $options = array();
                            ...
                            <?php
                                $options = array();
                                $options=array('anchor' => '50%','allowBlank'=>'true');
                                if (isset($parent_id))
                                ...
                                items: [{
                                        ...
                                        items:[{
                                            ...
                                            items:[ 
                                                    {
                                                    xtype: 'combo',
                                                    name: 'data[Employee][city]',
                                                    emptyText: 'All',
                                                    id: 'data[Employee][city]',
                                                    name: 'data[Employee][city]',
                                                    store : store_city,
                                                    displayField : 'city',
                                                    valueField : 'id',
                                                    ...
                                                    hideTrigger:true,
                                                    width:155,
                                                    value: '<?php echo $employee['Employee']['city']; ?>'
                                                },
                                                <?php
                                                    $options = array();
                            ...
                            { 
                                xtype: 'compositefield',
                                labelWidth: 120,
                                fieldLabel: '<span style="color:red;">*</span>Spouse Name:',
                                defaults: {
                                    flex: 1
                                },
                                items:[
                                    <?php
                                        ...
                                        $options3['value'] = $employee['Employee']['spouse_name'];
                                        $this->ExtForm->input('spouse_name', $options3);
                                    ?>,
                                    <?php
                                        $options4 = array(
                                            'enableKeyEvents' => 'true',
                                            'anchor' => '99%', 'emptyText' => 'የሚስት ወይም የባል ስም');
                                        $options4['listeners'] = '{
                                            keypress: function(tb,e){
                                                translateOnKeyPress(e,1);
                                            }
                                        }';
                                         $options4['value'] = $employee['Employee']['spouse_name_am'];
                                        $this->ExtForm->input('spouse_name_am', $options4);
                                    ?>
                                ]
                            },
                            {
                        ...
                        items: [
                            { 
                                ...
                                items:[
                                    <?php
                                        $options4 = array();
                                        $options4=array('anchor' => '70%');
                                        $options4['value']= $employee['Employee']['contact_name'];
                                        $this->ExtForm->input('contact_name', $options4);
                                    ?>,
                                    <?php
                                        $options5 = array(
                                            'enableKeyEvents' => 'true',
                                            'anchor' => '99%', 'emptyText' => 'የተያዥ ሙሉ ስም');
                                        $options5['listeners'] = '{
                                            keypress: function(tb,e){
                                                translateOnKeyPress(e,1);
                                            }
                                        }';
                                        $options5['value']= $employee['Employee']['contact_name_am'];
                                        $this->ExtForm->input('contact_name_am', $options5);
                                    ?>
                                ]
                            },
                            <?php
                            ...
                            ?>,
                                                {
                                                    xtype: 'combo',
                                                    name: 'data[Employee][contact_city]',
                                                    emptyText: 'All',
                                                    id: 'data[Employee][contact_city]',
                                                    name: 'data[Employee][contact_city]',
                                                    store : store_city,
                                                    displayField : 'city',
                                                    valueField : 'id',
                                                    ...
                                                    hideTrigger:true,
                                                    width:155,
                                                    value: '<?php echo $employee['Employee']['contact_city']; ?>'                                                },
                            <?php
                                $options = array();
                        ...
                        items: [
                            ...
                            { 
                                ...
                                items:[
                                    ...
                                    ?>,
                                    <?php
                                        $options = array('anchor' => '50%', 'emptyText' => 'ቀን/ወር/ዓመት');
                                        $options['value'] = $employee['Employee']['date_of_employment_am'];
                                        $this->ExtForm->input('date_of_employment_am', $options);
                                    ?>
                                ]
                            },
                            <?php
