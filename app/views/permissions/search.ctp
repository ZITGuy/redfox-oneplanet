...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Permission.name', '<?php __('Name'); ?>']
,			['Permission.is_builtin', '<?php __('Is Builtin'); ?>']
,			['Permission.created', '<?php __('Created'); ?>']
,			['Permission.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var permissionSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
	url: '<?php echo $this->Html->url(array('controller' => 'permissions', 'action' => 'search')); ?>',
...
var permissionSearchWindow = new Ext.Window({
	title: '<?php __('Search Permission'); ?>',
	modal: true,
