						...
						<div class="col-xs-12">
							...
							<div class="box">
								<div class="box-header">
									<center>
										<h2 style="margin-bottom: -10px;">Not Promoted Students of <?php echo $selected_ay['EduAcademicYear']['name']; ?></h2> 
										<?php $url = $this->Html->url(array('controller' => 'reports', 'action' => 'rpt_not_promoted_students')); ?>
										<?php $tag_image = $this->Html->image('print_m.png', array('align' => 'right', 'alt' => 'Print')); ?>
										<?php if(count($students)) { ?>
										<?php $url_print = $this->Html->url(array('controller' => 'reports', 'action' => 'rpt_not_promoted_students_print', $students[0]['EduClass']['id'])); ?>
								...
								<div class="box-body">
									...
									<table id="alphatable" class="table table-bordered table-striped" style="text-align:center">
										<tr>
											...
											<td><a href=<?php echo $url . '/' . $ay['EduAcademicYear']['id']; ?>><?php echo $ay['EduAcademicYear']['name']; ?></a></td>
											<?php } ?>
										</tr>
									</table>
									<table id="alphatable" class="table table-bordered table-striped" style="text-align:center">
										<tr>
											<td><a href=<?php echo $url .'/'. $ay_id . '/99'; ?>>All</a></td>
											<td><a href=<?php echo $url .'/'. $ay_id . '/1'; ?>>LKG</a></td>
											<td><a href=<?php echo $url .'/'. $ay_id . '/2'; ?>>UKG</a></td>
											<td><a href=<?php echo $url .'/'. $ay_id . '/3'; ?>>Preparatory</a></td>
											<td><a href=<?php echo $url .'/'. $ay_id . '/4'; ?>>1</a></td>
											<td><a href=<?php echo $url .'/'. $ay_id . '/5'; ?>>2</a></td>
											<td><a href=<?php echo $url .'/'. $ay_id . '/6'; ?>>3</a></td>
											<td><a href=<?php echo $url .'/'. $ay_id . '/7'; ?>>4</a></td>
											<td><a href=<?php echo $url .'/'. $ay_id . '/8'; ?>>5</a></td>
											<td><a href=<?php echo $url .'/'. $ay_id . '/9'; ?>>6</a></td>
											<td><a href=<?php echo $url .'/'. $ay_id . '/10'; ?>>7</a></td>
											<td><a href=<?php echo $url .'/'. $ay_id . '/11'; ?>>8</a></td>
											<td><a href=<?php echo $url .'/'. $ay_id . '/12'; ?>>9</a></td>
											<td><a href=<?php echo $url .'/'. $ay_id . '/13'; ?>>10</a></td>
											<td><a href=<?php echo $url .'/'. $ay_id . '/14'; ?>>11 - Natural</a></td>
											<td><a href=<?php echo $url .'/'. $ay_id . '/15'; ?>>11 - Social</a></td>
											<td><a href=<?php echo $url .'/'. $ay_id . '/16'; ?>>12 - Natural</a></td>
											<td><a href=<?php echo $url .'/'. $ay_id . '/17'; ?>>12 - Social</a></td>
										</tr>
									</table>
									<?php } ?>
									<br/>
