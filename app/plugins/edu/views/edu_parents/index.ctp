...
var store_eduParents = new Ext.data.Store({
	reader: new Ext.data.JsonReader({
		...
		fields: [
			'id','name','mother_telephone','mother_work_address','mother_work_telephone',
			'father_name','father_telephone','father_work_address','father_work_telephone', 
			'user','created','modified'		
		]
	}),
	proxy: new Ext.data.HttpProxy({
		url: "<?php echo $this->Html->url(array('controller' => 'edu_parents', 'action' => 'list_data')); ?>"
	}),	
...
if(center_panel.find('id', 'eduParent-tab') != "") {
	...
	var p = center_panel.add({
		...
		columns: [
			...
			{header: "<?php __('Telephone'); ?>", dataIndex: 'mother_telephone', sortable: true},
			{header: "<?php __('Work Address'); ?>", dataIndex: 'mother_work_address', sortable: true},
			{header: "<?php __('Work Telephone'); ?>", dataIndex: 'mother_work_telephone', sortable: true},
			{header: "<?php __('Father Name'); ?>", dataIndex: 'father_name', sortable: true},
			{header: "<?php __('Father Telephone'); ?>", dataIndex: 'father_telephone', sortable: true},
			{header: "<?php __('F. Work Address'); ?>", dataIndex: 'father_work_address', sortable: true},
			{header: "<?php __('F. Work Telephone'); ?>", dataIndex: 'father_work_telephone', sortable: true},
		...
		tbar: new Ext.Toolbar({
			...
			items: [{
					...
					text: "<?php __('Edit'); ?>",
					id: 'edit-eduParent',
					tooltip: "<?php __('<b>Edit Parents</b><br />Click here to modify the selected EduParent'); ?>",
					...
					text: "<?php __('Delete'); ?>",
					id: 'delete-eduParent',
					tooltip: "<?php __('<b>Delete Parents(s)</b><br />Click here to remove the selected EduParent(s)'); ?>",
