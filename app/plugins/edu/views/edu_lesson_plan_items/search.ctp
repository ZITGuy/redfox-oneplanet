...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['EduLessonPlan.name', '<?php __('EduLessonPlan'); ?>']
,			['EduPeriod.name', '<?php __('EduPeriod'); ?>']
,			['EduDay.name', '<?php __('EduDay'); ?>']
,			['EduOutline.name', '<?php __('EduOutline'); ?>']
,			['EduLessonPlanItem.created', '<?php __('Created'); ?>']
,			['EduLessonPlanItem.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var eduLessonPlanItemSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					eduLessonPlanItemSearchWindow.close();
...
var eduLessonPlanItemSearchWindow = new Ext.Window({
	title: '<?php __('Search EduLessonPlanItem'); ?>',
	modal: true,
	items: eduLessonPlanItemSearchForm,
	resizable: false,
	width: 550,
	height: 400,
