...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['EduRegistrationQuarter.name', '<?php __('EduRegistrationQuarter'); ?>']
,			['EduCourse.name', '<?php __('EduCourse'); ?>']
,			['EduRegistrationQuarterResult.course_result', '<?php __('Course Result'); ?>']
,			['EduRegistrationQuarterResult.result_indicator', '<?php __('Result Indicator'); ?>']
,			['EduRegistrationQuarterResult.created', '<?php __('Created'); ?>']
,			['EduRegistrationQuarterResult.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var eduRegistrationQuarterResultSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					eduRegistrationQuarterResultSearchWindow.close();
...
var eduRegistrationQuarterResultSearchWindow = new Ext.Window({
	title: '<?php __('Search EduRegistrationQuarterResult'); ?>',
	modal: true,
	items: eduRegistrationQuarterResultSearchForm,
	resizable: false,
	width: 550,
	height: 400,
