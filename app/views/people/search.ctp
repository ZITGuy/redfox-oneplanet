...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Person.first_name', '<?php __('First Name'); ?>']
,			['Person.middle_name', '<?php __('Middle Name'); ?>']
,			['Person.last_name', '<?php __('Last Name'); ?>']
,			['Person.birthdate', '<?php __('Birthdate'); ?>']
,			['BirthLocation.name', '<?php __('BirthLocation'); ?>']
,			['ResidenceLocation.name', '<?php __('ResidenceLocation'); ?>']
,			['Nationality.name', '<?php __('Nationality'); ?>']
,			['Person.kebele_or_farmers_association', '<?php __('Kebele Or Farmers Association'); ?>']
,			['Person.house_number', '<?php __('House Number'); ?>']
		]
	}),
	mode: 'local',
...
var personSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var personSearchWindow = new Ext.Window({
	title: '<?php __('Search Person'); ?>',
	modal: true,
	items: personSearchForm,
	resizable: false,
	width: 550,
	height: 400,
