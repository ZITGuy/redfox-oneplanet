...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['EduRegistration.name', '<?php __('EduRegistration'); ?>']
,			['EduQuarter.name', '<?php __('EduQuarter'); ?>']
,			['EduRegistrationQuarter.quarter_average', '<?php __('Quarter Average'); ?>']
,			['EduRegistrationQuarter.quarter_rank', '<?php __('Quarter Rank'); ?>']
,			['EduRegistrationQuarter.created', '<?php __('Created'); ?>']
,			['EduRegistrationQuarter.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var eduRegistrationQuarterSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					eduRegistrationQuarterSearchWindow.close();
...
var eduRegistrationQuarterSearchWindow = new Ext.Window({
	title: '<?php __('Search EduRegistrationQuarter'); ?>',
	modal: true,
	items: eduRegistrationQuarterSearchForm,
	resizable: false,
	width: 550,
	height: 400,
