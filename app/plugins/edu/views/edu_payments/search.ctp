...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['EduPaymentSchedule.name', '<?php __('EduPaymentSchedule'); ?>']
,			['EduStudent.name', '<?php __('EduStudent'); ?>']
,			['EduPayment.is_paid', '<?php __('Is Paid'); ?>']
,			['EduPayment.date_paid', '<?php __('Date Paid'); ?>']
,			['EduPayment.paid_amount', '<?php __('Paid Amount'); ?>']
,			['EduPayment.cheque_number', '<?php __('Cheque Number'); ?>']
,			['EduPayment.invoice', '<?php __('Invoice'); ?>']
,			['EduPayment.transaction_ref', '<?php __('Transaction Ref'); ?>']
,			['EduPayment.created', '<?php __('Created'); ?>']
,			['EduPayment.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var eduPaymentSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var eduPaymentSearchWindow = new Ext.Window({
	title: '<?php __('Search EduPayment'); ?>',
	modal: true,
	items: eduPaymentSearchForm,
	resizable: false,
	width: 550,
	height: 400,
