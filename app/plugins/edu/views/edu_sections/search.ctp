...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['EduSection.name', '<?php __('Name'); ?>']
,			['EduClass.name', '<?php __('EduClass'); ?>']
,			['EduAcademicYear.name', '<?php __('EduAcademicYear'); ?>']
,			['EduSection.created', '<?php __('Created'); ?>']
,			['EduSection.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var eduSectionSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var eduSectionSearchWindow = new Ext.Window({
	title: '<?php __('Search EduSection'); ?>',
	modal: true,
	items: eduSectionSearchForm,
	resizable: false,
	width: 550,
	height: 400,
