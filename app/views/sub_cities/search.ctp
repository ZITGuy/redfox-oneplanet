...
var subCitySearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var subCitySearchWindow = new Ext.Window({
	title: '<?php __('Search SubCity'); ?>',
	modal: true,
	items: subCitySearchForm,
	resizable: false,
	width: 550,
	height: 400,
