...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['EduDepartment.name', '<?php __('Name'); ?>']
		]
	}),
	mode: 'local',
...
var departmentSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var departmentSearchWindow = new Ext.Window({
	title: '<?php __('Search Department'); ?>',
	modal: true,
	items: departmentSearchForm,
	resizable: false,
	width: 550,
	height: 400,
