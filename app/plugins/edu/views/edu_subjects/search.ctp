...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['EduSubject.name', '<?php __('Name'); ?>'],
			['EduSubject.description', '<?php __('Description'); ?>'],
			['EduSubject.created', '<?php __('Created'); ?>'],
			['EduSubject.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var eduSubjectSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var eduSubjectSearchWindow = new Ext.Window({
	title: '<?php __('Search Subject'); ?>',
	modal: true,
	items: eduSubjectSearchForm,
	resizable: false,
	width: 550,
	height: 400,
