//<script>
    var store_eduLessonPlans = new Ext.data.GroupingStore({
        ...
        proxy: new Ext.data.HttpProxy({
            url: "<?php echo $this->Html->url(array('controller' => 'edu_lesson_plans', 'action' => 'list_data')); ?>"
        }), 
    ...
    function MaintainEduLessonPlan() {
        Ext.Ajax.request({
            url: "<?php echo $this->Html->url(array('controller' => 'edu_lesson_plans', 'action' => 'maintain')); ?>",
            ...
            failure: function (response, opts) {
                Ext.Msg.alert("<?php __('Error'); ?>", "<?php __('Cannot get the Lesson Plan Maintenance form. Error code'); ?>: " + response.status);
            }
        });
    }
    ...
    function EditEduLessonPlan(id) {
        Ext.Ajax.request({
            url: "<?php echo $this->Html->url(array('controller' => 'edu_lesson_plans', 'action' => 'edit')); ?>/" + id,
            success: function (response, opts) {
                var eduLessonPlan_data = response.responseText;
            ...
            failure: function (response, opts) {
                Ext.Msg.alert("<?php __('Error'); ?>", "<?php __('Cannot get the Lesson Plan edit form. Error code'); ?>: " + response.status);
            }
        });
    }
    ...
    function ViewEduLessonPlan(id) {
        Ext.Ajax.request({
            ...
            failure: function (response, opts) {
                Ext.Msg.alert("<?php __('Error'); ?>", "<?php __('Cannot get the Lesson Plan view form. Error code'); ?>: " + response.status);
            }
        });
    }
    function ViewParentEduLessonPlanItems(id) {
        Ext.Ajax.request({
            url: "<?php echo $this->Html->url(array('controller' => 'edu_lesson_plan_items', 'action' => 'index2')); ?>/" + id,
            success: function (response, opts) {
            ...
            failure: function (response, opts) {
                Ext.Msg.alert("<?php __('Error'); ?><?php __('Cannot get the Lesson Plan Items view form. Error code'); ?>: " + response.status);
            }
        });
    }
    ...
    function PostEduLessonPlan(id) {
        Ext.Ajax.request({
            url: "<?php echo $this->Html->url(array('controller' => 'edu_lesson_plans', 'action' => 'post_lesson_plan')); ?>/" + id,
            success: function (response, opts) {
                Ext.Msg.alert("<?php __('Success'); ?>", "<?php __('Lesson Plan successfully deleted!'); ?>");
                RefreshEduLessonPlanData();
            },
            failure: function (response, opts) {
                Ext.Msg.alert("<?php __('Error'); ?>", "<?php __('Cannot get the Lesson Plan add form. Error code'); ?>: " + response.status);
            }
        });
    }
    ...
    function DeleteEduLessonPlan(id) {
        Ext.Ajax.request({
            url: "<?php echo $this->Html->url(array('controller' => 'edu_lesson_plans', 'action' => 'delete')); ?>/" + id,
            success: function (response, opts) {
                Ext.Msg.alert("<?php __('Success'); ?>", "<?php __('Lesson Plan successfully deleted!'); ?>");
                RefreshEduLessonPlanData();
            },
    ...
    if (center_panel.find('id', 'eduLessonPlan-tab') != "") {
        var p = center_panel.findById('eduLessonPlan-tab');
        ...
        var p = center_panel.add({
            ...
            listeners: {
                celldblclick: function () {
                    ViewEduLessonPlan(Ext.getCmp('eduLessonPlan-tab').getSelectionModel().getSelected().data.id);
                }
            },
            ...
            tbar: new Ext.Toolbar({
                items: [{
                        ...
                        tooltip: "<?php __('<b>Maintain Lesson Plans</b><br />Click here to create/edit a new/existing Lesson Plan'); ?>",
                        ...
                        tooltip: "<?php __('<b>Post Lesson Plans</b><br />Click here to post the selected Lesson Plan for approval'); ?>",
                        ...
                        tooltip: "<?php __('<b>Delete Lesson Plans(s)</b><br />Click here to remove the selected Lesson Plan(s)'); ?>",
                        ...
                        tooltip: "<?php __('<b>View Lesson Plan</b><br />Click here to see details of the selected EduLessonPlan'); ?>",
