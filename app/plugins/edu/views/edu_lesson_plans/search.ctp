...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['EduCourse.name', '<?php __('EduCourse'); ?>']
,			['EduSection.name', '<?php __('EduSection'); ?>']
,			['EduLessonPlan.maker', '<?php __('Maker'); ?>']
,			['EduLessonPlan.checker', '<?php __('Checker'); ?>']
,			['EduLessonPlan.is_posted', '<?php __('Is Posted'); ?>']
,			['EduLessonPlan.posts', '<?php __('Posts'); ?>']
,			['EduLessonPlan.status', '<?php __('Status'); ?>']
,			['EduLessonPlan.reason', '<?php __('Reason'); ?>']
,			['EduLessonPlan.created', '<?php __('Created'); ?>']
,			['EduLessonPlan.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var eduLessonPlanSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
	url: '<?php echo $this->Html->url(array('controller' => 'eduLessonPlans', 'action' => 'search')); ?>',
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					eduLessonPlanSearchWindow.close();
...
var eduLessonPlanSearchWindow = new Ext.Window({
	title: '<?php __('Search EduLessonPlan'); ?>',
	modal: true,
	items: eduLessonPlanSearchForm,
	resizable: false,
	width: 550,
	height: 400,
