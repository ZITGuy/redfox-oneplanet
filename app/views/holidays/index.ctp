//<script>
    var store_holidays = new Ext.data.GroupingStore({
        reader: new Ext.data.JsonReader({
            ...
            fields: [
                'id', 'name', 'date', 'from_date', 'to_date', 'is_recurrent', 'created', 'modified']
        }),
    ...
    if (center_panel.find('id', 'holiday-tab') != "") {
        ...
        var p = center_panel.add({
            ...
            columns: [
                ...
                {header: "<?php __('Date Range'); ?>", dataIndex: 'date', sortable: true},
                {header: "<?php __('Is Recurrent?'); ?>", dataIndex: 'is_recurrent', sortable: true},
        ...
        p.getSelectionModel().on('rowselect', function (sm, rowIdx, r) {
            ...
            if(this.getSelections().length == 1) {
                ...
                if(record.get('from_date') < '<?php echo date('Y-m-d'); ?>') {
                    p.getTopToolbar().findById('edit-holiday').disable();
