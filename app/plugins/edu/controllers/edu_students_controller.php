...
class EduStudentsController extends EduAppController {
    ...
    public function list_data_section($id = null) {
        ...
        $conditions = array('EduRegistration.edu_section_id' => array($id, '0'), 'EduRegistration.edu_academic_year_id' => $ay['EduAcademicYear']['id']); // remove ", '0'" from here to remove Not Set students from the view
