...
var locationTypeSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					locationTypeSearchWindow.close();
...
var locationTypeSearchWindow = new Ext.Window({
	title: '<?php __('Search LocationType'); ?>',
	modal: true,
	items: locationTypeSearchForm,
	resizable: false,
	width: 550,
	height: 400,
