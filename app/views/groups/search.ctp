...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Group.name', '<?php __('Name'); ?>']
,			['Group.description', '<?php __('Description'); ?>']
,			['Group.is_builtin', '<?php __('Is Builtin'); ?>']
,			['Group.created', '<?php __('Created'); ?>']
,			['Group.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var groupSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var groupSearchWindow = new Ext.Window({
	title: '<?php __('Search Group'); ?>',
	modal: true,
