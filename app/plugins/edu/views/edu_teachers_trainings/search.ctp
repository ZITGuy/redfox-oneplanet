...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['EduTeacher.name', '<?php __('EduTeacher'); ?>']
,			['EduTraining.name', '<?php __('EduTraining'); ?>']
,			['EduTeachersTraining.from_date', '<?php __('From Date'); ?>']
,			['EduTeachersTraining.to_date', '<?php __('To Date'); ?>']
,			['EduTeachersTraining.trainer', '<?php __('Trainer'); ?>']
,			['EduTeachersTraining.remark', '<?php __('Remark'); ?>']
,			['EduTeachersTraining.deleted', '<?php __('Deleted'); ?>']
,			['EduTeachersTraining.created', '<?php __('Created'); ?>']
,			['EduTeachersTraining.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var eduTeachersTrainingSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					eduTeachersTrainingSearchWindow.close();
...
var eduTeachersTrainingSearchWindow = new Ext.Window({
	title: '<?php __('Search EduTeachersTraining'); ?>',
	modal: true,
	items: eduTeachersTrainingSearchForm,
	resizable: false,
	width: 550,
	height: 400,
