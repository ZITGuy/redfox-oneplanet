...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['EduOutline.name', '<?php __('Name'); ?>']
,			['EduCourse.name', '<?php __('EduCourse'); ?>']
,			['EduOutline.list_order', '<?php __('List Order'); ?>']
,			['EduOutline.created', '<?php __('Created'); ?>']
,			['EduOutline.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var eduOutlineSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var eduOutlineSearchWindow = new Ext.Window({
	title: '<?php __('Search EduOutline'); ?>',
	modal: true,
	items: eduOutlineSearchForm,
	resizable: false,
	width: 550,
	height: 400,
