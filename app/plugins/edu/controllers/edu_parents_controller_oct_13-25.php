...
class EduParentsController extends EduAppController {
    ...
    function push_parent_to_portal($id = null, $accessToken = null) {
		...
		$this->EduParent->set('portal_parent_id', $parent_id);
		if(!$this->EduParent->save()) {
			$this->log('cannot save portal_parent_id', 'debug');
		}
    ...
    function add_parent_data($accessToken, $parent) {
		...
		$portalRecordId = $parent['EduParent']['portal_parent_id'] == ''? '00000000-0000-0000-0000-000000000000': $parent['EduParent']['portal_parent_id'];
