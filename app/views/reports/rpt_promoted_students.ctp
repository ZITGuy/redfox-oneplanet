						...
						<div class="col-xs-12">
							...
							<div class="box">
								<div class="box-header">
									<center>
										<h2 style="margin-bottom: -10px;">Promoted Students of <?php echo $selected_ay['EduAcademicYear']['name']; ?></h2> 
										<?php $url = $this->Html->url(array('controller' => 'reports', 'action' => 'rpt_promoted_students')); ?>
										<?php $tag_image = $this->Html->image('print_m.png', array('align' => 'right', 'alt' => 'Print')); ?>
										<?php if(count($students)) { ?>
										<?php $url_print = $this->Html->url(array('controller' => 'reports', 'action' => 'rpt_promoted_students_print', $students[0]['EduClass']['id'])); ?>
