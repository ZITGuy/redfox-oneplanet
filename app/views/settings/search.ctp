...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Setting.setting_key', '<?php __('Setting Key'); ?>']
,			['Setting.setting_value', '<?php __('Setting Value'); ?>']
,			['Setting.date_from', '<?php __('Date From'); ?>']
,			['Setting.date_to', '<?php __('Date To'); ?>']
,			['Setting.remark', '<?php __('Remark'); ?>']
		]
	}),
	mode: 'local',
...
var settingSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var settingSearchWindow = new Ext.Window({
	title: '<?php __('Search Setting'); ?>',
	modal: true,
	items: settingSearchForm,
	resizable: false,
	width: 550,
	height: 400,
