...
,			['AuditTrail.session_name', '<?php __('Session Name'); ?>']
,			['AuditTrail.action_made', '<?php __('Action Made'); ?>']
,			['AuditTrail.table_name', '<?php __('Table Name'); ?>']
,			['AuditTrail.old_value', '<?php __('Old Value'); ?>']
,			['AuditTrail.new_value', '<?php __('New Value'); ?>']
,			['AuditTrail.record_id', '<?php __('Record Id'); ?>']
,			['AuditTrail.created', '<?php __('Created'); ?>']
		]
	}),
	mode: 'local',
...
var auditTrailSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var auditTrailSearchWindow = new Ext.Window({
	title: '<?php __('Search AuditTrail'); ?>',
	modal: true,
	items: auditTrailSearchForm,
	resizable: false,
	width: 550,
	height: 400,
