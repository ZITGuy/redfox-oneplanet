...
var g = new Ext.grid.GridPanel({
	...
	columns: [
		...
		{header:"<?php __('report_category'); ?>", dataIndex: 'report_category', sortable: true},
					...
					items: [
 {
				...
				cls: 'x-btn-text-icon',
				text: '
Strict Standards: Non-static method I18n::translate() should not be called statically in C:\wamp\www\etham\cake\basics.php on line 655

Strict Standards: Non-static method I18n::getInstance() should not be called statically in C:\wamp\www\etham\cake\libs\i18n.php on line 130

Strict Standards: Non-static method Configure::read() should not be called statically in C:\wamp\www\etham\cake\libs\i18n.php on line 142

Strict Standards: Non-static method Configure::getInstance() should not be called statically in C:\wamp\www\etham\cake\libs\configure.php on line 154
GO',
