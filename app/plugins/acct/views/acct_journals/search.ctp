...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['AcctTransaction.name', '<?php __('AcctTransaction'); ?>']
,			['AcctAccount.name', '<?php __('AcctAccount'); ?>']
,			['AcctJournal.dr', '<?php __('Dr'); ?>']
,			['AcctJournal.cr', '<?php __('Cr'); ?>']
,			['AcctJournal.bbf', '<?php __('Bbf'); ?>']
,			['AcctJournal.created', '<?php __('Created'); ?>']
,			['AcctJournal.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var acctJournalSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var acctJournalSearchWindow = new Ext.Window({
	title: '<?php __('Search AcctJournal'); ?>',
	modal: true,
	items: acctJournalSearchForm,
	resizable: false,
	width: 550,
	height: 400,
