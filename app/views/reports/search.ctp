...
,			['Report.description', '<?php __('Description'); ?>']
,			['Report.function_name', '<?php __('Function Name'); ?>']
,			['ReportCategory.name', '<?php __('ReportCategory'); ?>']
,			['Report.created', '<?php __('Created'); ?>']
,			['Report.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
