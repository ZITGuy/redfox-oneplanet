...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['EduCalendarEventType.name', '<?php __('Name'); ?>']
		]
	}),
	mode: 'local',
...
var eduCalendarEventTypeSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					eduCalendarEventTypeSearchWindow.close();
...
var eduCalendarEventTypeSearchWindow = new Ext.Window({
	title: '<?php __('Search EduCalendarEventType'); ?>',
	modal: true,
	items: eduCalendarEventTypeSearchForm,
	resizable: false,
	width: 550,
	height: 400,
