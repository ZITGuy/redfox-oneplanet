		...
		items:[{
			...
			items: [
                ...
                <?php 
					...
					$options6['value'] = $user['User']['edu_campus_id'];
                    $this->ExtForm->input('edu_campus_id', $options6);
                ?>,
                <?php 
                    $options7 = array('fieldLabel' => 'Can Change Campus', 'value' => $user['User']['change_campus']);
                    $this->ExtForm->input('change_campus', $options7);
                ?>,
				<?php 
					$options2 = array();
...
?>
			...
			items: [
				...
				<?php 
					...
					$options9['value'] = $user['Person']['birth_location'];
					$this->ExtForm->input('birth_location', $options9);
				?>,
				<?php 
					$options10 = array('anchor' => '80%');
					$options10['value'] = $user['Person']['residence_location'];
					$this->ExtForm->input('residence_location', $options10);
				?>,
				<?php 
					$options11 = array();
