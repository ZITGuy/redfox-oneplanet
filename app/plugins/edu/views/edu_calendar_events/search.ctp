...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['EduCalendarEvent.name', '<?php __('Name'); ?>']
,			['EduCalendarEventType.name', '<?php __('EduCalendarEventType'); ?>']
,			['EduCalendarEvent.start_date', '<?php __('Start Date'); ?>']
,			['EduCalendarEvent.end_date', '<?php __('End Date'); ?>']
,			['EduQuarter.name', '<?php __('EduQuarter'); ?>']
,			['EduCalendarEvent.created', '<?php __('Created'); ?>']
,			['EduCalendarEvent.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var eduCalendarEventSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					eduCalendarEventSearchWindow.close();
...
var eduCalendarEventSearchWindow = new Ext.Window({
	title: '<?php __('Search EduCalendarEvent'); ?>',
	modal: true,
	items: eduCalendarEventSearchForm,
	resizable: false,
	width: 550,
	height: 400,
