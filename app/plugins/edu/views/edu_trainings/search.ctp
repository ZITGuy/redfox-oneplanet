...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['EduTraining.name', '<?php __('Name'); ?>']
,			['EduTraining.category', '<?php __('Category'); ?>']
,			['EduTraining.deleted', '<?php __('Deleted'); ?>']
,			['EduTraining.created', '<?php __('Created'); ?>']
,			['EduTraining.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var eduTrainingSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
	url: '<?php echo $this->Html->url(array('controller' => 'eduTrainings', 'action' => 'search')); ?>',
...
var eduTrainingSearchWindow = new Ext.Window({
	title: '<?php __('Search EduTraining'); ?>',
	modal: true,
	items: eduTrainingSearchForm,
	resizable: false,
	width: 550,
	height: 400,
