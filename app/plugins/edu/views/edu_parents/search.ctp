...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['EduParent.name', '<?php __('Name'); ?>']
,			['User.name', '<?php __('User'); ?>']
,			['EduParent.created', '<?php __('Created'); ?>']
,			['EduParent.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var eduParentSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var eduParentSearchWindow = new Ext.Window({
	title: '<?php __('Search EduParent'); ?>',
	modal: true,
	items: eduParentSearchForm,
	resizable: false,
	width: 550,
	height: 400,
