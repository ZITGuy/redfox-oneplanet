//<script>
    ...
    var EduStudentWithdrawalForm = new Ext.form.FormPanel({
        baseCls: 'x-plain',
        labelWidth: 100,
        labelAlign: 'right',
        url:'<?php echo $this->Html->url(array('controller' => 'edu_students', 'action' => 'withdraw_student')); ?>',
        ...
        items: [{
            ...
            ?>,
            <?php 
                $options_reason = array('fieldLabel' => 'Withdrawal Reason', 'xtype' => 'textarea');
                $this->ExtForm->input('reason', $options_reason);
            ?>
        ]
    });
		
    var EduStudentWithdrawalWindow = new Ext.Window({
        title: '<?php __('Withdraw Student(s)'); ?>',
        width: 700,
        minWidth: 700,
        autoHeight: true,
        layout: 'fit',
        ...
        buttonAlign:'right',
        items: EduStudentWithdrawalForm,
        tools: [{
            id: 'refresh',
            qtip: 'Reset',
            handler: function () {
                EduStudentWithdrawalForm.getForm().reset();
            },
            scope: this
        }, {
            id: 'help',
            ...
            handler: function () {
                Ext.Msg.show({
                    ...
                    msg: 'This form is used to Withdraw Students.',
            ...
            handler: function () {
                if(EduStudentWithdrawalWindow.collapsed)
                        EduStudentWithdrawalWindow.expand(true);
                else
                        EduStudentWithdrawalWindow.collapse(true);
            }
        }],
        buttons: [{
                text: '<?php __('Withdraw'); ?>',
                handler: function(btn){
                    EduStudentWithdrawalForm.getForm().submit({
                        ...
                        success: function(f,a){
                            ...
                            EduStudentWithdrawalWindow.close();
                        },
    ...
    EduStudentWithdrawalWindow.show();