...
,			['EduPeriod.edu_course_Id', '<?php __('Edu Course Id'); ?>']
,			['EduSchedule.name', '<?php __('EduSchedule'); ?>']
,			['EduPeriod.day', '<?php __('Day'); ?>']
,			['EduPeriod.period', '<?php __('Period'); ?>']
		]
	}),
	mode: 'local',
...
var eduPeriodSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var eduPeriodSearchWindow = new Ext.Window({
	title: '<?php __('Search EduPeriod'); ?>',
	modal: true,
	items: eduPeriodSearchForm,
	resizable: false,
	width: 550,
	height: 400,
