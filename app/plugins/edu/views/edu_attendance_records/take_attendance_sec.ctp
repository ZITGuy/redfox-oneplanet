//<script>
    ...
    var TakeAttendanceForm = new Ext.form.FormPanel({
        ...
        closeAction: 'hide',
        url:'<?php echo $this->Html->url(array(
            'controller' => 'edu_attendance_records', 'action' => 'take_attendance_sec')); ?>',
    ...
    function saveOrSubmitAttendance(btn) {
        ...
        Ext.Ajax.request({
            url: '<?php echo $this->Html->url(array('controller' => 'edu_attendance_records', 'action' => 'save_attendance')); ?>',
            params: param,
            method: 'POST',
            success: function(){
