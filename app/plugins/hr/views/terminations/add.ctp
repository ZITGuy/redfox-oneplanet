			...
			items: [
				...
				<?php 
					$options = array();
                                        ...
                                        $options['items'] = array('Contract Not Renewed' => 'Contract Not Renewed', 'Deceased' => 'Deceased','Dismissed'=>'Dismissed','Laid-off'=>'Laid-off','Physically Disabled/Compensated'=>'Physically Disabled/Compensated','Resigned'=>'Resigned','Resigned - Company Requested'=>'Resigned - Company Requested','Resigned - Self Proposed'=>'Resigned - Self Proposed','Retired'=>'Retired','Other'=>'Other');
