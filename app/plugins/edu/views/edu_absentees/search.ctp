...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['AttendanceRecord.name', '<?php __('AttendanceRecord'); ?>']
,			['Student.name', '<?php __('Student'); ?>']
,			['Absentee.code', '<?php __('Code'); ?>']
,			['Absentee.reason', '<?php __('Reason'); ?>']
		]
	}),
	mode: 'local',
...
var absenteeSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var absenteeSearchWindow = new Ext.Window({
	title: '<?php __('Search Absentee'); ?>',
	modal: true,
	items: absenteeSearchForm,
	resizable: false,
	width: 550,
	height: 400,
