...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['EduQuarter.name', '<?php __('Name'); ?>']
,			['EduQuarter.start_date', '<?php __('Start Date'); ?>']
,			['EduQuarter.end_date', '<?php __('End Date'); ?>']
,			['EduAcademicYear.name', '<?php __('EduAcademicYear'); ?>']
,			['EduQuarter.status', '<?php __('Status'); ?>']
,			['EduQuarter.created', '<?php __('Created'); ?>']
,			['EduQuarter.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var eduQuarterSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var eduQuarterSearchWindow = new Ext.Window({
	title: '<?php __('Search EduQuarter'); ?>',
	modal: true,
	items: eduQuarterSearchForm,
	resizable: false,
	width: 550,
	height: 400,
