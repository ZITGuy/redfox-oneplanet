...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['AcctAccount.name', '<?php __('Name'); ?>']
,			['AcctAccount.code', '<?php __('Code'); ?>']
,			['AcctCategory.name', '<?php __('AcctCategory'); ?>']
,			['AcctAccount.balance', '<?php __('Balance'); ?>']
,			['User.name', '<?php __('User'); ?>']
,			['AcctAccount.created', '<?php __('Created'); ?>']
,			['AcctAccount.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var acctAccountSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
	url: '<?php echo $this->Html->url(array('controller' => 'acctAccounts', 'action' => 'search')); ?>',
...
var acctAccountSearchWindow = new Ext.Window({
	title: '<?php __('Search AcctAccount'); ?>',
	modal: true,
	items: acctAccountSearchForm,
	resizable: false,
	width: 550,
	height: 400,
