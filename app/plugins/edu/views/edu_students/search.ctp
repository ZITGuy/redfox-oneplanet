...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['EduStudent.name', '<?php __('Name'); ?>']
,			['EduStudent.birth_date', '<?php __('Birth Date'); ?>']
,			['EduStudent.registration_date', '<?php __('Registration Date'); ?>']
,			['EduParent.name', '<?php __('EduParent'); ?>']
,			['EduStudent.created', '<?php __('Created'); ?>']
,			['EduStudent.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var eduStudentSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
	url: '<?php echo $this->Html->url(array('controller' => 'eduStudents', 'action' => 'search')); ?>',
...
var eduStudentSearchWindow = new Ext.Window({
	title: '<?php __('Search Student'); ?>',
	modal: true,
	items: eduStudentSearchForm,
	resizable: false,
	width: 550,
	height: 400,
